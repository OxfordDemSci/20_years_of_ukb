...
WHY THIS EXISTS
---------------
Three files import this module by its old, unqualified name:
    ...
    src/data_analysis/04_non_academic_04_collab_analysis.ipynb   (`import ... as h`)
...
this shim keeps the three callers working.
