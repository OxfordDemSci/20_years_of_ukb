#!/usr/bin/env python3
"""Recreate the '10 Most Common Areas of Broad Research' horizontal bar chart."""
...
def make_plot(output_path: Path) -> None:
    ...
    ax.set_title("10 Most Common Areas of Broad Research", fontsize=18, weight="bold", pad=18)
...
if __name__ == "__main__":
    ...
    output_files = [
        output_dir / "top10_broad_research_areas_recreated.png",
        output_dir / "top10_broad_research_areas_recreated.pdf",
        output_dir / "top10_broad_research_areas_recreated.svg",
    ]
