...
argued with and extended. It was first written for the clinical-trials analysis
(`04_non_academic.ipynb`, Part I, §3.4) against the 157 tags those trials carry; the
...
# =============================================================================
# Group 1: from 04_non_academic Part I, §3.4, unchanged.
_STOP_TRIALS = {
